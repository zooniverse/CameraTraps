...
db_name = 'trans_test_annotations'
db_file = '/home/ubuntu/efs/databases/eccv_18_annotation_files/'+db_name+'.json'

plot_directory = '/home/ubuntu/efs/databases/Plots/'+db_name
...
if 'location' in images[0]:
    ...
    plt.ylabel('Number of images')
    plt.xlabel('Location')
    plt.legend(catNames, loc='center left', bbox_to_anchor=(1.005,0.5), fontsize=4)
...
>>>>>>> 22576139cf1812188a5e75c5d3e523a4ada6e4b7
